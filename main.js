import { Earth, Mars, Moon, PlanetComposable, Position, RotatedPlanet, Sun, MoveRotateAlgorithm, RenderSquarePlanetAlgorithm, RenderCirclePlanetAlgorithm} from './src/solar-system.js';
...
function renderPlanets() {
  ...
  function renderAsteroids(canvas, array, borderSize = 10) {
  const ctx = canvas.getContext('2d');
